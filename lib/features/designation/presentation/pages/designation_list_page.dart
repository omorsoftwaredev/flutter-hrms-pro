        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              AppSectionTitle(
                title:
                'Designation List (${designationState.filteredDesignations.length})',
              ),
                          ...
                          onDelete: () async {
                            ...
                            if (context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    '${designation.name} deleted successfully.',
                                  ),
                                ),
                              );
                            }
